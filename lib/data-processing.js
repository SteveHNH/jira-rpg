...
export function transformWebhookToTicketData(payload) {
  ...
  return {
    ...
    description: extractDescription(fields.description) || `Work on: ${fields.summary || 'assigned task'}`,
    status: fields.status?.name || 'Unknown',
    reporter: fields.reporter?.displayName || fields.creator?.displayName || 'Quest Giver',
