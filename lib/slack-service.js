...
function formatStoryMessage(storyData, ticketInfo) {
  ...
  // Debug logging
  console.log('formatStoryMessage - storyData:', JSON.stringify(storyData, null, 2));
  ...
  console.log('formatStoryMessage - extracted story:', JSON.stringify(story, null, 2));
  ...
  function sanitizeText(text, maxLength = 3000) {
    ...
    if (typeof text === 'object') {
      console.warn('sanitizeText received object:', text);
  ...
  console.log('formatStoryMessage - final storyText:', storyText);
...
function formatTeamStoryMessage(storyData, ticketInfo, userInfo) {
  ...
  // Debug logging
  console.log('formatTeamStoryMessage - storyData:', JSON.stringify(storyData, null, 2));
  
  // Extract story data from new or old format
  const story = newStoryData ? newStoryData : { story: narrative, loot: null, achievements: null };
  
  console.log('formatTeamStoryMessage - extracted story:', JSON.stringify(story, null, 2));
  ...
  console.log('formatTeamStoryMessage - final storyText:', storyText);
